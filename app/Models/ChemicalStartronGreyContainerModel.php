...
class ChemicalStartronGreyContainerModel extends Model
{
    protected $table = 'chemical_startron_grey_container';
    protected $primaryKey = 'id_chemical_startron_grey_container';
    protected $allowedFields = [
        'id_cpp', 'based_awal_shift', 'based_akhir_shift', 'use_awal_shift', 
        'use_akhir_shift', 'total_consumption', 'consumption', 'tanggal'  // Menambahkan 'tanggal'
    ];
