...
<body>
    ...
    <script>
        function exportToExcel() {
            ...
            const data = [
                { Nama: "John Doe", Email: "john@example.com", Tanggal: "2023-11-01" },
                { Nama: "Jane Smith", Email: "jane@example.com", Tanggal: "2023-11-01" },
                { Nama: "David Lee", Email: "david@example.com", Tanggal: "2023-11-02" }
            ];
